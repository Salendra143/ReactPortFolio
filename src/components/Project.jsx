      ...
      <div className=" flex justify-evenly gap-5 px-5 sm:px-20 mx-auto  flex-wrap ">
        ...
        <div className="w-[200px] h-[200px] cursor-pointer relative md:w-[300px] md:h-[300px] rounded-2xl">
          <img
            ...
            alt=""
          />
          <div className="absolute inset-0 bg-cyan-400 opacity-0 hover:opacity-100 transition-opacity duration-1000 font-bold text-black ease-in-out rounded-2xl flex sm:justify-center sm:items-center sm:text-center flex-col p-2  md:p-8 ">
