        ...
        <div className='w-full lg:w-3/4 mx-auto   sm:flex justify-between '>
          ...
          <div className='flex gap-5 flex-col   pt-5 px-8  sm:w-2/4 '>
                ...
                <FaPhoneVolume className='text-[2rem]' />
                  ...
                  <p className='text-[1.1rem]'>7011579066</p>
                </div>
          ...
          <form className='  flex   flex-col  sm:w-2/4 px-8'>
              <input className=' p-3 bg-gray-950 rounded-lg mt-5 border-2 border-cyan-400 placeholder:text-white placeholder:text-[1.2rem]' type="email"  placeholder='UserName'/>
              <input  className=' p-3  bg-gray-950 rounded-lg mt-5 border-2 border-cyan-400 placeholder:text-white placeholder:text-[1.2rem]' type="password"  placeholder='Password' />
              <textarea className=' p-3  bg-gray-950 rounded-lg my-5 border-2 border-cyan-400 placeholder:text-white placeholder:text-[1.2rem]' name="" rows={6} cols={10} placeholder='Message' id=""></textarea>
              <button className='p-3 bg-gray-950 border-2 italic border-cyan-400 text-[1.5rem] '>Send Message</button>  
      </form>
